...
public class AjaxResult extends HashMap<String, Object> {
    ...
    public static AjaxResult success() {
        return new AjaxResult("操作成功", HttpStatus.OK.value());
    }

    public static AjaxResult success(Object data) {
        return new AjaxResult("操作成功", HttpStatus.OK.value(), data);
    }
    ...
    public static AjaxResult error() {
        return new AjaxResult("操作失败", HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
