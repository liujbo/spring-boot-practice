...
@Service
@Slf4j
public class ExcelMergeService_2 {

    private static final int MAX_CACHE_SIZE = 1000;
    private static final int MAX_MEMORY_ROWS = 5000; // 内存中最大行数限制

    /**
     * 优化版合并方法，减少内存占用
     */
    public byte[] mergeExcelSheetsToZip_2(List<MultipartFile> excelFiles) throws IOException {
        // 1. 先分析结构，不加载数据
